...
const HeatMap = (props) => {
  ...
  const drawChart = useCallback((dataset, containerEl) => {
    ...
    const mouseover = function(d) {
      ...
      svg.selectAll(`.${d.variable}`).selectAll('rect').style('opacity', 1);
      svg.selectAll(`.${d.variable}`).selectAll('text').style('opacity', 1);
